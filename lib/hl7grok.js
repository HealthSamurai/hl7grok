...
(function() {
  var VALID_OPTION_KEYS, _structurize, coerce, deprefixGroupName, fs, getMeta, parse, parseComponents, parseFields, parseSegments, replaceBlanksWithNulls, structurize, validateOptions;
  ...
  parse = function(msg, options) {
    var errors, hl7version, message, messageType, meta, msh, parseErrors, ref, ref1, segments, separators, structErrors;
