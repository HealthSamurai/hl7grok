...
(function() {
  var _structurize, coerce, deprefixGroupName, fs, getMeta, parse, parseComponents, parseFields, parseSegments, replaceBlanksWithNulls, structurize;
  ...
  parseComponents = function(value, fieldId, meta, separators) {
    var fieldMeta, fieldType, result, splitRegexp, typeMeta;
    ...
    if (typeMeta) {
      ...
      value.split(splitRegexp).forEach(function(c, index) {
        var componentId, componentMax, componentMeta, componentMin, componentValue, ref;
